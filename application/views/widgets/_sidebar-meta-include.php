<div class="panel">
  ...
  <div class="job-meta">
    <?php foreach($this->job->getMeta() as $key => $meta){
      ...
      ?>
      <div class="meta-pair meta-<?php echo $meta['slug'] ?> <?php if($meta['hide']) echo 'not-priority '; else echo 'priority '; if(is_null($meta['value']->get())) echo 'edit-mode '?>">
