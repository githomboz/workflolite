<div class="main-mid-section clearfix">
  <div class="main-mid-section-inner clearfix">
    ...
    <h1><?php echo $this->workflow->getValue('name') ?></h1>
    <h4><?php echo $this->workflow->getValue('description') ?></h4>
    ...
    <?php $templates = $this->workflow->getTemplates(); //var_dump($templates);
    ...
    <div class="roles-list entities-list widget">
      ...
      <form method="post" class="boxed sidepanel-bg">
        ...
        <?php $roles = (array) $this->workflow->getValue('roles'); ?>
        <?php if(!empty($roles)){?>
    ...
    <div class="meta-list entities-list widget">
      ...
      <div class="boxed sidepanel-bg">
        ...
        <?php $metaFields = (array) $this->workflow->getValue('metaFields'); ?>
