...
class Builder
{
  ...
  public function switch_db($dsn = ''){
    return $this->switchDb($dsn);
  }
  ...
  public function drop_collection($database = '', $collection = ''){
    return $this->dropCollection($database, $collection);
  }
  ...
  public function where_in($field = '', $inValues = array())
  {
    return $this->whereIn($field, $inValues);
  }
  ...
  public function whereInAll($field = '', $inValues = array())
  {
    ...
    public function where_in_all($field = '', $inValues = array())
    {
      return $this->whereInAll($field, $inValues);
    }
  ...
  public function where_not_in($field = '', $inValues = array()){
    return $this->whereNotIn($field, $inValues);
  }
  ...
  public function whereBetween($field = '', $valueX = 0, $valueY = 0)
  {
    ...
    public function where_between($field = '', $valueX = 0, $valueY = 0)
    {
      return $this->whereBetween($field, $valueX, $valueY);
    }
  ...
  public function where_between_ne($field = '', $valueX, $valueY)
  {
    return $this->whereBetweenNe($field, $valueX, $valueY);
  }
  ...
  {
    return $this->whereNe($field, $value);
  }
  ...
  {
    return $this->whereNear($field, $coords, $distance, $spherical);
  }
                            ...
                            $enableStartWildcard = true, $enableEndWildcard = true)
  {
    ...
    public function where_like($field = '', $value = '', $flags = 'i', $enableStartWildcard = true, $enableEndWildcard = true)
    {
      return $this->whereLike($field, $value, $flags, $enableStartWildcard, $enableEndWildcard);
    }
  ...
  {
    return $this->getWhere($collection, $where);
  }
                              ...
                              $options = array())
  {
    ...
    {
      return $this->batchInsert($collection, $insert, $options);
    }
  ...
  public function updateAll($collection = '', $options = array())
  {
    ...
    {
      return $this->updateAll($collection, $options);
    }
  ...
  public function addToSet($field, $values)
  {
    ...
    {
      return $this->addToSet($field, $values);
    }
  ...
  public function renameField($oldName, $newName)
  {
    ...
    public function rename_field($oldName, $newName)
    {
      return $this->renameField($oldName, $newName);
    }
  ...
  public function deleteAll($collection = '')
  {
    ...
    {
      return $this->deleteAll($collection);
    }
                           ...
                           $options = array())
  {
    ...
    {
      return $this->addIndex($collection, $fields, $options);
    }
  ...
  public function removeIndex($collection = '', $keys = array())
  {
    ...
    {
      return $this->removeIndex($collection, $keys);
    }
  ...
  {
    return $this->removeAllIndexes($collection);
  }
  ...
  public function listIndexes($collection = '')
  {
    ...
    {
      return $this->listIndexes($collection);
    }
  ...
  private function _show_error($error_message = '', $response_code = 500)
  {
    ...
    {
      throw new \MongoQB\Exception ($error_message);
